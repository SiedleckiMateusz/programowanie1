...
public class PersonOperators {
    ...
    public static void main(String[] args) {
        ...
        //uzywamy tej metody do wyswietlenia wszystkich elementow listy
        System.out.println("NASZA LISTA: ");
        consumeList(persons, p-> System.out.println(p));

        System.out.println();
        System.out.println("ZWIEKSZAMY WIEK O 1");
        ...
        System.out.println();
        System.out.println("WYSWIETLAMY TYLKO PELNOLETNIE OSOBY");
